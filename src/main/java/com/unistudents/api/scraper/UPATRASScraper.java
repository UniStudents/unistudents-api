...
public class UPATRASScraper {
    ...
    private final Logger logger = LoggerFactory.getLogger(UPATRASScraper.class);
    ...
    private void getHtmlPages(String username, String password) {
        ...
        response.cookies().forEach(newSessionCookies::put);
    ...
    public boolean isAuthorized(Connection.Response response, Map<String, String> JSESSIONID) {
        try {
    ...
    public void setInfoAndGradesPage(Document infoAndGradesPage) {
