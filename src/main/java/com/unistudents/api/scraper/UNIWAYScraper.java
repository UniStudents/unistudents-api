...
public class UNIWAYScraper {
    ...
    private final Logger logger = LoggerFactory.getLogger(UNIWAYScraper.class);
    ...
    private String getBetweenStrings(String text, String textFrom, String textTo) {
        try {
            ...
            logger.error("Error: {}", e.getMessage() + " | With text: " + text, e);
        }
        return null;
    }
    ...
    public void setDeclareHistoryJSON(String declareHistoryJSON) {
